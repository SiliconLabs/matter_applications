...
public:
    enum Action_t
    {
        ON_ACTION = 0,
        OFF_ACTION,
        MOVE_TO_LEVEL_ACTION,
        MOVE_TO_HUE_SAT_ACTION,
        INVALID_ACTION
    } Action;
    ...
    enum State_t
    {
        ...
        kState_OffCompleted,
        kState_OnInitiated,
        kState_MoveToLevelInitiated,
        kState_MoveToHueSatInitiated,
        kState_OnCompleted,
        kState_MoveToLevelCompleted,
        kState_MoveToHueSatCompleted,
    } State;
    ...
    void SetColorHue(uint8_t hue);
    void SetColorSaturation(uint8_t sat);
