...
CHIP_ERROR SilabsLCD::Init(uint8_t * name, bool initialState)
{
    ...
    //< WW2023: Add support for 2 states
    dState.mainState1 = initialState;
    dState.mainState2 = initialState;
    //>
...
// WW2023: Change signature to include 2 boolean states
void SilabsLCD::WriteDemoUI(bool state, bool sel)
{
#ifdef QR_CODE_ENABLED
    if (mShowQRCode)
    {
    ...
    if(sel)
    {
      dState.mainState1 = state;
    }
    else
    {
      dState.mainState2 = state;
    }
    //>
    WriteDemoUI();
}
...
void SilabsLCD::WriteDemoUI()
{
    ...
    else
    {
        ...
        // WW2023: Add support for dual states
        demoUIDisplayApp(dState.mainState1, dState.mainState2);
    }
}
